...
// For production, consider using environment variables for additional security
const firebaseConfig = {
  apiKey: process.env.FIREBASE_API_KEY || "AIzaSyCnH3YyYNU0RO-ohpqaaZ2-ak1C52-gsXI",
  authDomain: process.env.FIREBASE_AUTH_DOMAIN || "utalostandfound-42797.firebaseapp.com",
  projectId: process.env.FIREBASE_PROJECT_ID || "utalostandfound-42797",
  storageBucket: process.env.FIREBASE_STORAGE_BUCKET || "utalostandfound-42797.firebasestorage.app",
  messagingSenderId: process.env.FIREBASE_MESSAGING_SENDER_ID || "404965401963",
  appId: process.env.FIREBASE_APP_ID || "1:404965401963:web:b8051d3c08b3915b9c982e",
  measurementId: process.env.FIREBASE_MEASUREMENT_ID || "G-CRBYQ80ESQ"
};
